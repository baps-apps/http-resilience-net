...
{
    /// <summary>
    /// When true, installs a custom <see cref="SocketsHttpHandler"/> configured from the properties below.
    /// When false (default), no primary handler is installed and behavior is identical to calling <c>AddStandardResilienceHandler</c> directly.
    /// <para><b>Use case:</b> Set to true when you need to control connection pooling (e.g. DNS TTL recycling, connection limits, connect timeout).</para>
    /// </summary>
